...
set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_AUDIO
  "${CMAKE_CURRENT_SOURCE_DIR}/Common/Audio/SoundEngine.cpp"
)
source_group("Common/Source Files/Audio" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_AUDIO})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_NETWORK
...
source_group("Common/Source Files/Network" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_NETWORK})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI
...
source_group("Common/Source Files/UI" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_COMPONENTS
...
source_group("Common/Source Files/UI/Components" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_COMPONENTS})
...
source_group("Common/Source Files/UI/Controls" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_CONTROLS})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES
...
source_group("Common/Source Files/UI/Scenes" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_DEBUG
...
source_group("Common/Source Files/UI/Scenes/Debug" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_DEBUG})
...
source_group("Common/Source Files/UI/Scenes/Frontend Menu screens" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_FRONTEND_MENU_SCREENS})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_HELP__OPTIONS
...
source_group("Common/Source Files/UI/Scenes/Help & Options" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_HELP__OPTIONS})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_INGAME_MENU_SCREENS
...
source_group("Common/Source Files/UI/Scenes/In-Game Menu Screens" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_INGAME_MENU_SCREENS})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_INGAME_MENU_SCREENS_CONTAINERS
...
source_group("Common/Source Files/UI/Scenes/In-Game Menu Screens/Containers" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_INGAME_MENU_SCREENS_CONTAINERS})

set(_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_ZLIB
...
source_group("Common/Source Files/zlib" FILES ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_ZLIB})
...
set(_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES
...
source_group("Windows64/Source Files" FILES ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES})

set(_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_LEADERBOARDS
  "${BASE_DIR}/Leaderboards/WindowsLeaderboardManager.cpp"
  "${BASE_DIR}/Leaderboards/WindowsLeaderboardManager.h"
)
source_group("Windows64/Source Files/Leaderboards" FILES ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_LEADERBOARDS})

set(_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SENTIENT
...
source_group("Windows64/Source Files/Sentient" FILES ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SENTIENT})

set(_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SOCIAL
  "${BASE_DIR}/Social/SocialManager.h"
)
source_group("Windows64/Source Files/Social" FILES ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SOCIAL})
...
set(_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_NETWORK
  "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/Network/NetworkPlayerXbox.cpp"
  "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/Network/NetworkPlayerXbox.h"
)
source_group("Xbox/Source Files/Network" FILES ${_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_NETWORK})

set(_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_SENTIENT_DYNAMICCONF
  "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/Sentient/trialConfigv1.bin"
)
source_group("Xbox/Source Files/Sentient/DynamicConf" FILES ${_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_SENTIENT_DYNAMICCONF})

set(_MINECRAFT_CLIENT_WINDOWS_XBOX_RES
  # "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/res/terrain_MipmapLevel2.bmp"
  # "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/res/terrain_MipmapLevel3.bmp"
)
source_group("Xbox/res" FILES ${_MINECRAFT_CLIENT_WINDOWS_XBOX_RES})

set(_MINECRAFT_CLIENT_WINDOWS_XBOX_RES_AUDIO
  # "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/res/audio/minecraft.xsb"
  # "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/res/audio/resident.xwb"
  # "${CMAKE_CURRENT_SOURCE_DIR}/Xbox/res/audio/streamed.xwb"
)
source_group("Xbox/res/audio" FILES ${_MINECRAFT_CLIENT_WINDOWS_XBOX_RES_AUDIO})
...
set(MINECRAFT_CLIENT_WINDOWS
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_AUDIO}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_NETWORK}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_COMPONENTS}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_CONTROLS}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES}
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_UI_SCENES_DEBUG}
  ...
  ${_MINECRAFT_CLIENT_WINDOWS_COMMON_SOURCE_FILES_ZLIB}
  ...
  ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_LEADERBOARDS}
  ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SENTIENT}
  ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_SOURCE_FILES_SOCIAL}
  ${_MINECRAFT_CLIENT_WINDOWS_WINDOWS64_XML}
  ${_MINECRAFT_CLIENT_WINDOWS_XBOX_SENTIENTLIBS_INC}
  ${_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_NETWORK}
  ${_MINECRAFT_CLIENT_WINDOWS_XBOX_SOURCE_FILES_SENTIENT_DYNAMICCONF}
  ${_MINECRAFT_CLIENT_WINDOWS_XBOX_RES}
  ${_MINECRAFT_CLIENT_WINDOWS_XBOX_RES_AUDIO}
