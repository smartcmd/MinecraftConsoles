...
void DefineActions(void)
{
	...
	InputManager.SetGameJoypadMaps(MAP_STYLE_0,MINECRAFT_ACTION_PICK_ITEM,				_PS4_JOY_BUTTON_DPAD_DOWN);
	...
	InputManager.SetGameJoypadMaps(MAP_STYLE_1,MINECRAFT_ACTION_PICK_ITEM,				_PS4_JOY_BUTTON_DPAD_DOWN);
	...
	InputManager.SetGameJoypadMaps(MAP_STYLE_2,MINECRAFT_ACTION_PICK_ITEM,				_PS4_JOY_BUTTON_DPAD_DOWN);
	...
	InputManager.SetGameJoypadMaps(MAP_STYLE_3,MINECRAFT_ACTION_PICK_ITEM,				_PS4_JOY_BUTTON_DPAD_DOWN);
